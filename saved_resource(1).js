...
function t898_checkPhoneNumber(recid) {
  var el = $('#rec' + recid);
  var whatsapp = el.find('.t898__whatsapp').attr('data-messenger-whatsapp');
  var telegram = el.find('.t898__telegram').attr('data-messenger-telegram');
  var telegramLink = el
      .find('.t898__telegram_link')
      .attr('data-messenger-telegram-link');
  var vk = el.find('.t898__vk').attr('data-messenger-vk');
  var skype = el.find('.t898__skype').attr('data-messenger-skype');
  var skypeChat = el
      .find('.t898__skype_chat')
      .attr('data-messenger-skype-chat');
  var mail = el.find('.t898__mail').attr('data-messenger-mail');
  var viber = el.find('.t898__viber').attr('data-messenger-viber');
  var fb = el.find('.t898__fb').attr('data-messenger-fb');
  var phone = el.find('.t898__phone').attr('data-messenger-phone');

  if (typeof telegramLink != 'undefined') {
      if (telegramLink.search(/http/i) !== -1) {
          el.find('.t898__telegram_link').attr('href', telegramLink);
      } else {
          if (telegramLink.search(/tg/i) !== -1) {
              el.find('.t898__telegram_link').attr('href', telegramLink);
          } else {
              el.find('.t898__telegram_link').attr(
                  'href',
                  'https://' + telegramLink
              );
          }
  ...
  el.find('.t898__telegram').attr('href', 'https://t.me/' + telegram);
  el.find('.t898__vk').attr('href', 'https://vk.me/' + vk);

  if (typeof skype != 'undefined') {
      el.find('.t898__skype').attr(
          'href',
  ...
  if (typeof viber != 'undefined') {
      el.find('.t898__viber').attr(
          'href',
          'viber://chat?number=%2B' + viber.replace(/[+?^${}()|[\]\\\s]/g, '')
      );
  }

  el.find('.t898__mail').attr('href', 'mailto:' + mail);

  el.find('.t898__fb').attr('href', 'https://m.me/' + fb);

  if (typeof phone != 'undefined') {
      el.find('.t898__phone').attr(
          'href',
